...
from mailings.services import complete_mailing, schedule_mailing_tasks
from mailings.views import MailListView, MailDetailView, MailUpdateView, MailDeleteView, MailCreateView, \
    MailingCreateView, MailingDetailView, MailingDeleteView, MailingUpdateView, MailingAttemptListView
...
urlpatterns = [
    ...
    path('schedule_mailing_tasks/<int:pk>/', schedule_mailing_tasks, name='schedule_mailing_tasks'),
